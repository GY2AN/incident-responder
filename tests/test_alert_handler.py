...
async def test_handle_firing_alert():
    ...
    with patch("app.alert_handler.get_runbook", new_callable=AsyncMock) as mock_runbook, \
         patch("app.alert_handler.post_to_slack", new_callable=AsyncMock) as mock_slack:
